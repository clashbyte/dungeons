...
//    if (!(
//        abs(vWorldPos.x - uClipSphere.x) > uClipSphere.w ||
//        abs(vWorldPos.y - uClipSphere.y) > uClipSphere.w ||
//        abs(vWorldPos.z - uClipSphere.z) > uClipSphere.w
//    )) {
//        discard;
//    }
